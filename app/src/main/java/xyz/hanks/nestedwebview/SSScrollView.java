...
public class SSScrollView extends FrameLayout implements NestedScrollingParent,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(SSScrollView v, int scrollX, int scrollY,
    ...
    public boolean dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed,
        ...
        Log.e("......",".........webview"+ViewCompat.canScrollVertically(((ViewGroup)getChildAt(0)).getChildAt(0), -1));
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final SSScrollView nsvHost = (SSScrollView) host;
